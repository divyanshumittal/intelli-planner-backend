...
@RestController
@RequestMapping(value = "api/v1/crusher")
@Api(value = "Crusher", description = "The Crusher API")
public class CrusherController {

    @Autowired
    ICrusherService service;
    ...
    @ApiOperation(value = "Create Crusher", notes = "Create a new Crusher")
    public Crusher create(@Valid @RequestBody @ApiParam(value = "The Resource to be Created") final Crusher resource) {
        ...
        Crusher crusher = service.create(resource);
        return crusher;
    }
    ...
    public Page<Crusher> findAllPaginatedAndSorted(@RequestParam("page") final int page,
    ...
    public Page<Crusher> search(@RequestParam("page") final int page,
            @RequestParam("size") final int size,
            @RequestParam("sortBy") final String sortBy,
            @RequestParam("sortOrder") final String sortOrder) {
    ...
    public void update(@PathVariable("id") @ApiParam(value = "The Id of the Existing Resource to be Updated") final String id,
            @Valid @RequestBody @ApiParam(value = "The Resource to be Updated") final Crusher resource) {
        Preconditions.checkNotNull(resource, "Resource provided is null");
    ...
    public Crusher findOne(@PathVariable("id") @ApiParam(value = "The Id of the Existing Resource to be Retrieved") final String id) {
        Crusher crusher = service.findOne(id);
        Preconditions.checkNotNull(crusher, "Crusher not found by id = " + id);
        return crusher;
    }
