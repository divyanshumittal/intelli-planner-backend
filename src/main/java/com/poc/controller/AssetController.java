...
public class AssetController {
    ...
    public Asset create(@Valid @RequestBody @ApiParam(value = "The Resource to be Created") final Asset resource) {
        ...
        Asset equipment = service.create(resource);
        return equipment;
    }
    ...
    public Page<Asset> findAllPaginatedAndSorted(@RequestParam("page") final int page,
    ...
    public Page<Asset> search(@RequestParam("page") final int page,
                                 @RequestParam("size") final int size,
                                 @RequestParam("sortBy") final String sortBy,
                                 @RequestParam("sortOrder") final String sortOrder) {
    ...
    public void update(@PathVariable("id") @ApiParam(value = "The Id of the Existing Resource to be Updated") final String id,
                       @Valid @RequestBody @ApiParam(value = "The Resource to be Updated") final Asset resource) {
        Preconditions.checkNotNull(resource, "Resource provided is null");
    ...
    public Asset findOne(@PathVariable("id") @ApiParam(value = "The Id of the Existing Resource to be Retrieved") final String id) { // @formatter:on
        Asset equipment = service.findOne(id);
