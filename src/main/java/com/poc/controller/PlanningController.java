...
public class PlanningController {
    ...
    public Planning create(@Valid @RequestBody @ApiParam(value = "The Resource to be Created") final Planning resource) {
        ...
        Planning equipment = service.create(resource);
        return equipment;
    }
    ...
    public Page<Planning> findAllPaginatedAndSorted(@RequestParam("page") final int page,
    ...
    public Page<Planning> search(@RequestParam("page") final int page,
                                  @RequestParam("size") final int size,
                                  @RequestParam("sortBy") final String sortBy,
                                  @RequestParam("sortOrder") final String sortOrder) {
    ...
    public void update(@PathVariable("id") @ApiParam(value = "The Id of the Existing Resource to be Updated") final String id,
                       @Valid @RequestBody @ApiParam(value = "The Resource to be Updated") final Planning resource) {
        Preconditions.checkNotNull(resource, "Resource provided is null");
    ...
    public Planning findOne(@PathVariable("id") @ApiParam(value = "The Id of the Existing Resource to be Retrieved") final String id) { // @formatter:on
        Planning equipment = service.findOne(id);
