...
public class GanttTaskController {
    ...
    public GanttTask create(@Valid @RequestBody @ApiParam(value = "The Resource to be Created") final GanttTask resource) {
        ...
        GanttTask equipment = service.create(resource);
        return equipment;
    }
    ...
    public GanttTask findOne(@PathVariable("id") @ApiParam(value = "The Id of the Existing Resource to be Retrieved") final String id) { // @formatter:on
        GanttTask equipment = service.findOne(id);
