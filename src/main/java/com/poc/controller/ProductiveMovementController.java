...
import com.poc.service.IProductiveMovementService;
...
@RestController
@RequestMapping(value = "api/v1/productivemovement")
@Api(value = "productivemovement", description = "The ProductiveMovement API")
public class ProductiveMovementController {

    @Autowired
    IProductiveMovementService service;
    ...
    @ApiOperation(value = "Create ProductiveMovement", notes = "Create a new ProductiveMovement")
    public ProductiveMovement create(@Valid @RequestBody @ApiParam(value = "The Resource to be Created") final ProductiveMovement resource) {
        ...
        ProductiveMovement productivemovement = service.create(resource);
        return productivemovement;
    }
    ...
    public List<ProductiveMovement> findAll() {
    ...
    public Page<ProductiveMovement> findAllPaginatedAndSorted(@RequestParam("page") final int page,
    ...
    public Page<ProductiveMovement> search(@RequestParam("page") final int page,
            @RequestParam("size") final int size,
            @RequestParam("sortBy") final String sortBy,
            @RequestParam("sortOrder") final String sortOrder) {
    ...
    public void update(@PathVariable("id") @ApiParam(value = "The Id of the Existing Resource to be Updated") final String id,
            @Valid @RequestBody @ApiParam(value = "The Resource to be Updated") final ProductiveMovement resource) {
        Preconditions.checkNotNull(resource, "Resource provided is null");
    ...
    public ProductiveMovement findOne(@PathVariable("id") @ApiParam(value = "The Id of the Existing Resource to be Retrieved") final String id) {
        ProductiveMovement productivemovement = service.findOne(id);
        Preconditions.checkNotNull(productivemovement, "productivemovement not found by id = " + id);
        return productivemovement;
    }
