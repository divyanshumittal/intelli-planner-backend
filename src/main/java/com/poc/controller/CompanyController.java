...
public class CompanyController {
    ...
    public Company create(@Valid @RequestBody @ApiParam(value = "The Resource to be Created") final Company resource) {
        ...
        Company equipment = service.create(resource);
        return equipment;
    }
    ...
    public Page<Company> findAllPaginatedAndSorted(@RequestParam("page") final int page,
    ...
    public Page<Company> search(@RequestParam("page") final int page,
                                 @RequestParam("size") final int size,
                                 @RequestParam("sortBy") final String sortBy,
                                 @RequestParam("sortOrder") final String sortOrder) {
    ...
    public void update(@PathVariable("id") @ApiParam(value = "The Id of the Existing Resource to be Updated") final String id,
                       @Valid @RequestBody @ApiParam(value = "The Resource to be Updated") final Company resource) {
        Preconditions.checkNotNull(resource, "Resource provided is null");
    ...
    public Company findOne(@PathVariable("id") @ApiParam(value = "The Id of the Existing Resource to be Retrieved") final String id) { // @formatter:on
        Company equipment = service.findOne(id);
